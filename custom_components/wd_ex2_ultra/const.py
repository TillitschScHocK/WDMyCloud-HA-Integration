...
SENSORS = [
    ...
    },
    {
        "key": "cpu_core2",
        "name": "CPU Core 2",
        "oid": HR_PROCESSOR_LOAD + ".196609",
        "unit": "%",
        "icon": "mdi:cpu-64-bit",
        "device_class": None,
        "state_class": "measurement",
    },
    # --- RAM (hrStorageTable, alloc_unit = 1024 B) ---
    {
        "key": "ram_total",
        "name": "RAM Total",
        "oid": HR_STORAGE_SIZE + ".1",
        "unit": UnitOfInformation.MEBIBYTES,
        "icon": "mdi:memory",
        "device_class": "data_size",
        "state_class": "measurement",
        "transform": "hr_1k_blocks_to_mib",
    },
    {
        "key": "ram_used",
        "name": "RAM Used",
        "oid": HR_STORAGE_USED + ".1",
        "unit": UnitOfInformation.MEBIBYTES,
        "icon": "mdi:memory",
        "device_class": "data_size",
        "state_class": "measurement",
    ...
    # --- Swap (hrStorageTable, alloc_unit = 1024 B) ---
    {
        "key": "swap_total",
        "name": "Swap Total",
        "oid": HR_STORAGE_SIZE + ".10",
        "unit": UnitOfInformation.MEBIBYTES,
